...
export default function FavorisPage() {
  ...
  const handleFaireOffre = (property: Property) => {
    ...
    if (offreExistante) {
      ...
      setOffreForm({ montant: '', message: '', mode: Mode.CASH });
    }
    ...
    try {
      const res = await fetch('/api/acheteur/mesOffres', {
        ...
        body: JSON.stringify({
          ...
          mode: offreForm.mode || Mode.CASH, // Valeur par défaut
        }),
      })
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <div className="p-4 pt-0 flex flex-col gap-2">
                    ...
                    <button
                      onClick={() => removeFavorite(property.id)}
                      className="bg-red-100 text-gray-500 px-3 py-2 rounded-md hover:bg-red-50 hover:text-red-500 transition-all duration-200 border border-gray-200"
                      title="Retirer des favoris"
                    >
              ...
              {/* Mode de paiement (optionnel pour acompte) */}
                <div className="mb-6">
                  ...
                  <select
                    id="mode"
                    name="mode"
                    value={offreForm.mode || ''}
                    onChange={(e) => setOffreForm({ ...offreForm, mode: e.target.value as Mode })}
